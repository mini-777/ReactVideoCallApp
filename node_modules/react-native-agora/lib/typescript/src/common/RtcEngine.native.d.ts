import type { BeautyOptions, CameraCapturerConfiguration, ChannelMediaRelayConfiguration, ClientRoleOptions, EncryptionConfig, LastmileProbeConfig, LiveInjectStreamConfig, LiveTranscoding, UserInfo, VideoEncoderConfiguration, WatermarkOptions } from './Classes';
import { AreaCode, AudioEffectPreset, AudioEqualizationBandFrequency, AudioProfile, AudioRecordingQuality, AudioReverbPreset, AudioReverbType, AudioSampleRateType, AudioScenario, AudioSessionOperationRestriction, AudioVoiceChanger, ChannelProfile, ClientRole, ConnectionStateType, EncryptionMode, LogFilter, StreamFallbackOptions, UserPriority, VideoStreamType, VoiceBeautifierPreset } from './Enums';
...
export default class RtcEngine implements RtcEngineInterface {
     ...
     *    - 7(NotInitialized): The SDK is not initialized.
     */
    joinChannel(token: string | undefined | null, channelName: string, optionalInfo: string | undefined | null, optionalUid: number): Promise<void>;
    /**
     ...
     */
    switchChannel(token: string | undefined | null, channelName: string): Promise<void>;
    /**
     ...
     *
     */
    joinChannelWithUserAccount(token: string | undefined | null, channelName: string, userAccount: string): Promise<void>;
    /**
