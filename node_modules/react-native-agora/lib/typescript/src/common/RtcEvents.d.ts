import type { AudioVolumeInfo, FacePositionInfo, LastmileProbeResult, LocalAudioStats, LocalVideoStats, Rect, RemoteAudioStats, RemoteVideoStats, RtcStats, UserInfo } from './Classes';
import type { AudioLocalError, AudioLocalState, AudioMixingErrorCode, AudioMixingStateCode, AudioOutputRouting, AudioRemoteState, AudioRemoteStateReason, ChannelMediaRelayError, ChannelMediaRelayEvent, ChannelMediaRelayState, ClientRole, ConnectionChangedReason, ConnectionStateType, ErrorCode, InjectStreamStatus, LocalVideoStreamError, LocalVideoStreamState, NetworkQuality, NetworkType, RtmpStreamingErrorCode, RtmpStreamingEvent, RtmpStreamingState, StreamPublishState, StreamSubscribeState, UserOfflineReason, VideoRemoteState, VideoRemoteStateReason, WarningCode } from './Enums';
/**
 * @internal
 * @ignore
 */
