...
export class VideoEncoderConfiguration {
  ...
  constructor(params) {
    ...
    this.dimensions = params === null || params === void 0 ? void 0 : params.dimensions;
    this.frameRate = params === null || params === void 0 ? void 0 : params.frameRate;
    this.minFrameRate = params === null || params === void 0 ? void 0 : params.minFrameRate;
    this.bitrate = params === null || params === void 0 ? void 0 : params.bitrate;
    this.minBitrate = params === null || params === void 0 ? void 0 : params.minBitrate;
    this.orientationMode = params === null || params === void 0 ? void 0 : params.orientationMode;
    this.degradationPrefer = params === null || params === void 0 ? void 0 : params.degradationPrefer;
    this.mirrorMode = params === null || params === void 0 ? void 0 : params.mirrorMode;
  }
...
export class BeautyOptions {
  ...
  constructor(params) {
    ...
    this.lighteningContrastLevel = params === null || params === void 0 ? void 0 : params.lighteningContrastLevel;
    this.lighteningLevel = params === null || params === void 0 ? void 0 : params.lighteningLevel;
    this.smoothnessLevel = params === null || params === void 0 ? void 0 : params.smoothnessLevel;
    this.rednessLevel = params === null || params === void 0 ? void 0 : params.rednessLevel;
  }
...
export class TranscodingUser {
  ...
  constructor(uid, x, y, params) {
    ...
    this.x = x;
    this.y = y;
    this.width = params === null || params === void 0 ? void 0 : params.width;
    this.height = params === null || params === void 0 ? void 0 : params.height;
    this.zOrder = params === null || params === void 0 ? void 0 : params.zOrder;
    this.alpha = params === null || params === void 0 ? void 0 : params.alpha;
    this.audioChannel = params === null || params === void 0 ? void 0 : params.audioChannel;
  }
...
export class LiveTranscoding {
  ...
  constructor(transcodingUsers, params) {
    ...
    this.width = params === null || params === void 0 ? void 0 : params.width;
    this.height = params === null || params === void 0 ? void 0 : params.height;
    this.videoBitrate = params === null || params === void 0 ? void 0 : params.videoBitrate;
    this.videoFramerate = params === null || params === void 0 ? void 0 : params.videoFramerate;
    this.lowLatency = params === null || params === void 0 ? void 0 : params.lowLatency;
    this.videoGop = params === null || params === void 0 ? void 0 : params.videoGop;
    this.watermark = params === null || params === void 0 ? void 0 : params.watermark;
    this.backgroundImage = params === null || params === void 0 ? void 0 : params.backgroundImage;
    this.audioSampleRate = params === null || params === void 0 ? void 0 : params.audioSampleRate;
    this.audioBitrate = params === null || params === void 0 ? void 0 : params.audioBitrate;
    this.audioChannels = params === null || params === void 0 ? void 0 : params.audioChannels;
    this.audioCodecProfile = params === null || params === void 0 ? void 0 : params.audioCodecProfile;
    this.videoCodecProfile = params === null || params === void 0 ? void 0 : params.videoCodecProfile;
    this.backgroundColor = params === null || params === void 0 ? void 0 : params.backgroundColor;
    this.userConfigExtraInfo = params === null || params === void 0 ? void 0 : params.userConfigExtraInfo;
...
export class ChannelMediaInfo {
  ...
  constructor(uid, params) {
    ...
    this.channelName = params === null || params === void 0 ? void 0 : params.channelName;
